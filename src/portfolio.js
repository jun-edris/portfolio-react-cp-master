...
const socialMediaLinks = {
	github: 'https://github.com/jun-edris',
	linkedin: 'https://www.linkedin.com/in/junaire-edris-buico-33b93a205/',
	...
	twitter: 'https://twitter.com/BuicoEdris',
	...
	schools: [
		{
			...
			logo: require('./assets/images/BISU-LOGO.png'),
	...
	achievementsCards: [
		{
			...
			image: require('./assets/images/Postman - Postman Student Expert - 2021-02-22.png'),
			footerLink: [
				{
					name: 'Certification',
					url: require('./assets/images/Certification.jpg'),
				},
				// {
				// 	name: 'Award Letter',
				// 	url: '',
...
const twitterDetails = {
	userName: 'BuicoEdris', //Replace "twitter" with your twitter username without @
	display: true, // Set true to display this section, defaults to false
};
